var LR_imgurl = 'http://pht.zoosnet.net/';
var LR_lng = 'cn';
var LR_lxurl = 'http://pht.zoosnet.net/';
var LiveReceptionCode_isonline = 1;
var LR_b9286='7FBA9FF1300A41148E6C8CC211983D92';LR_b9286=((5+1).toString()+LR_b9286+(5*1).toString());var LR_siteid = '34098849';
var LR_websiteid = 'PHT34098849';
var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_sysurl = 'http://pht.zoosnet.net/';
var LR_5ce7b=LR_b9286.replace(/4/g,'8').replace(/5/g,'3');var LR_ssl = 0;
var LR_isMobile = 1;
var LR_422c4=LR_5ce7b.replace(/1/g,'3').replace(/0/g,'2');if(typeof(LR_showfloat)=='undefined' || LR_showfloat!=1)var LR_showfloat = 1;
var LR_ab8bf=LR_422c4.replace(/1/g,'3').replace(/0/g,'2');var LR_MGAB=LR_ab8bf.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	var _lr_helpalt_on=unescape("%u4f18%u9038%u5ba2UI%u5b9e%u8bad%u6b22%u8fce%u60a8");
	var _lr_helpsrc_on=unescape("http%3a%2f%2fpht.zoosnet.net%2fjs%2fm_blue%2f1.gif");
	var _lr_helpalt_of=unescape("");
	var _lr_helpsrc_of=unescape("http%3a%2f%2fpht.zoosnet.net%2fjs%2fm_blue%2f1.gif");
	...
	var LR_invitestring1_auto=unescape("%3cP style%3d%22FONT-SIZE%3a 9pt%22%3e%3cSTRONG%3e%u4f18%u9038%u5ba2%u5c31%u4e1a%2f%u57f9%u8bad%2f%u5b9e%u8bad%u57fa%u5730 %u6211%u4eec%u4e13%u6ce8%u4e8e%u4e13%u6ce8%2f%u6781%u81f4%2f%u53e3%u7891%3cBR%3e%3c%2fSTRONG%3e%u3010%3cSTRONG%3e%3cFONT color%3dred%3e%u57f9%u8bad%u8d39%u7528%3c%2fFONT%3e%3c%2fSTRONG%3e%u3011%uff1a%u5148%u5c31%u4e1a%uff0c%u540e%u4ed8%u6b3e%uff0c%u7ec8%u751f%u4fdd%u969c%u5c31%u4e1a%u670d%u52a1%uff0c%u8f7b%u677e%u5b66%u4e60%uff0c%u4fdd%u8d28%u4fdd%u91cf%uff01%3cBR%3e%u3010%3cSTRONG%3e%3cFONT color%3dred%3e%u7cbe%u54c1%u8bfe%u7a0b%3c%2fFONT%3e%3c%2fSTRONG%3e%u3011%uff1a%u5168%u65b9%u4f4d%u8bbe%u8ba1UI%2fPHP%2f%u4ea4%u4e92%u754c%u9762%2f%u5e73%u9762%2f%u7f51%u9875%2f%u7f8e%u5de5%2f%u6e38%u620f%u8bbe%u8ba1%u7b49%uff01%3cBR%3e%u3010%3cSTRONG%3e%3cFONT color%3dred%3e%u540d%u5e08%u6559%u5b66%3c%2fFONT%3e%3c%2fSTRONG%3e%u3011%uff1a%u8d44%u6df1%u5b98%u65b9%u8ba4%u8bc1%u8bb2%u5e08%u6388%u8bfe%uff01%3cBR%3e%u3010%3cSTRONG%3e%3cFONT color%3dred%3e%u54a8%u8be2%u597d%u793c%3c%2fFONT%3e%3c%2fSTRONG%3e%u3011%uff1a%u5728%u7ebf%u54a8%u8be2%uff0c%u53ef%u7533%u8bf7%u514d%u8d39%u8bd5%u5b66%u540d%u989d%uff01%u5b66UI%2f%u5e73%u9762%2f%u7f8e%u5de5%2f%u4ea4%u4e92%u754c%u9762%2f%u79fb%u52a8%u7aef%u8bbe%u8ba1%2f%u6e38%u620f%u8bbe%u8ba1%uff0c%3cSTRONG%3e%u9996%u9009%u4f18%u9038%u5ba2%3c%2fSTRONG%3e%uff0c%u54c1%u8d28%u9886%u5148%uff01%3cBR%3e%u3010%3cSTRONG%3e%3cFONT color%3dred%3e%u7533%u8bf7%u514d%u8d39%u8bd5%u5b66%u540d%u989d%3c%2fFONT%3e%3c%2fSTRONG%3e%u3011%u7559%u4e0b%u3010%3cSTRONG%3e%u59d3%u540d%2b%u7535%u8bdd%3c%2fSTRONG%3e%u3011%u7533%u8bf7%u514d%u8d39%u8bd5%u5b66%u540d%u989d%uff0c%u9650%u989d100%u540d%uff0c%u5148%u5230%u5148%u5f97%uff01%u4eb2%u8eab%u4f53%u9a8c%uff0c%3cFONT color%3dred%3e%u675c%u7edd%u865a%u5047%3cBR%3e%3c%2fFONT%3e%3c%2fP%3e");
	...
	var _lr_mobileinviteimgsrc=unescape("http%3a%2f%2fpht.zoosnet.net%2fsite%2f34098849%2fminvite_cn.jpg");
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&HGCC='+LR_MGAB;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		document.write('<link href="http://pht.zoosnet.net/js/JS5.css" rel="stylesheet" type="text/css" />');
var LR_MCount1 = 5000;
...
window.addEventListener('message', function (e) {
         ...
         function minibarhtml() {
             return '<div id="LRMINIBar" class="LR_Mini_ICON" style="display:none;' + (LR_pm011 ? 'left' : 'right') + ': 15px;bottom: ' + LR_pm012 + 'px;" onclick="lrminiMax();"><a class="LR-BTN" style="background-color: ' + LR_pm006 + ';' + (LR_pm008 == 2 ? 'display:none;' : '') + '"><span class="LR-ICON LR-ICON-CHAT1" id="LR-BTN-ICON"></span><span id="LR-CIRCLE" style="display:none;background-color: ' + LR_pm006 + ';"></span> </a><a id="LR-BUBBLE" style="display:none;cursor:pointer;right: 0;bottom: ' + LR_pm012 + 'px;"><span class="LR-ICON" id="LR-BUBBLE-CLOSE" onclick="return closebarhtml(event);"></span><div id="LR-BUBBLE-INSIDE"><div id="LR-BUBBLE-title"><img id="LR-BUBBLE-AVATAR" src=""><span id="LR-BUBBLE-NAME"></span></div><div id="LR-BUBBLE-MSG"></div></div></a></div>';
         }
...
function lr_useraa() {if (typeof (openZoosUrl) != 'function') {setTimeout('lr_useraa()', 100);return;} if(!LR_isMobile){LR_UserInviteDiv = '<div id="swtbox" style="width:700px; height:520px; background:url(http://www.sxuek.com/img/shangwutongtanchuang.jpg); overflow:hidden; position:relative"><div id="swtColse" style="z-index: 5; width: 42px; height: 42px; top: 14px; right: 12px; position: absolute;"><a href="javascript:void(0)" onclick="{1}return false;" style="display:block;width: 42px; height: 42px;  text-indent:-999em;"></a></div><div id="swtColse" style="z-index: 1; width:700px; height:520px; position: absolute; "><a href="javascript:void(0)" onclick="{0}return false;" style="display:block; text-indent:-999em;width:700px; height:520px "></a></div></div>';}}lr_useraa();if(!LR_isMobile){var lr_xCenter = 350;var lr_yCenter = 260;}}
